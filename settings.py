...
# ===========================================
# AI設定（LM Studio / OpenAI互換）
# ===========================================
# LM StudioはAPIキー不要だが、OpenAIクライアントの仕様上文字列が必要
OPENAI_API_KEY = os.getenv('OPENAI_API_KEY', 'lm-studio')
# 例: http://localhost:1234/v1 もしくは LM Studio サーバのURL
OPENAI_BASE_URL = os.getenv('OPENAI_BASE_URL', 'http://192.168.0.199:1234/v1')
# 使用するモデル名（LM Studioでロードしたモデル）
